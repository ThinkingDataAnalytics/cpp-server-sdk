...
/* The src stuff here below is mainly for time_t! */
#include <sys/types.h>
#include <time.h>
...
/* HP-UX systems version 9, 10 and 11 lack sys/select.h and so does oldish
   libc5-based Linux systems. Only src it on systems that are known to
   require it! */
...
/* unfortunately, the easy.h and multi.h src files need options and info
